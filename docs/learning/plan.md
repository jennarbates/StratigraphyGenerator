...
**The pages have fixed shapes — use them.** Workflow pages always run: Before
...
it is optional and experimental. Reaching that step counts as completing it.
...
1. Cluster 2, **Stratigraphy and chronology** (12 pages) — pairs directly
...
2. Cluster 3, **Survey, measurement, and recording** (13 pages) — pairs with
...
(place on site) — reread those two pages first. Graphs explain the Harris

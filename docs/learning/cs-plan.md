...
- The two notes files from day one: a personal glossary in your own words,
  ...
  validation/sanitisation), because the catalogue is full of near-neighbour
  pairs.
...
| 9: Synthesis | algorithm index, pipeline mapping, capstone | n/a | 12–16 |
| **Total** | | **128** | **~100–130** |
...
labels only, which is all the archaeology this course requires.

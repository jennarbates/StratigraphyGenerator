...
def _friendly_error(e):
    """json.JSONDecodeError almost always means a truncated Gemini response
    that slipped past this app's own check (or was extracted before that
    check existed) -- point back at the fix rather than the raw parser
    error."""
